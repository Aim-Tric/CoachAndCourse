            ...
            <div class="col-md-9">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group col-md-offset-3 login-panel-button-group">
                        <button type="button" class="btn btn-success" id="do-register" name="do-register">确认注册</button>
...
<script>
    $('#do-register').on('click', function (e) {
        e.stopPropagation();
        e.preventDefault();
        // var form = form_datas({
        //     handle: 'form',
        ...
        $.ajax({
            ...
            dataType: 'text',
            data: {'method': 'register','json': JSON.stringify(arr)},
            success: function (result) {
                ...
                setInterval(function () {
                    pw.text(popText + fadeSec + "s 后调回主页面");
                    fadeSec -= 1;
                    if (fadeSec === 0) {
